...
#Paths for glioma, meningioma, pituitary, and no tumor training folders
...
# Data paths for training folder, validation folder, and testing folder
...
# Predictions and visualization of only 25 images and their predictions alongside with ground truths
