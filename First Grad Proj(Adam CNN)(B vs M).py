...
#Path for the Malignant training data
Yes_Tumor = '\\Users\\adham\\OneDrive\\Desktop\\Grad Proj Datasets\Datasets (Normal)\Brain Tumors 2 Class (Benign&Malignant)\\Training\\Malignant'
...
#Path for the benign training data
No_Tumor = '\\Users\\adham\\OneDrive\\Desktop\\Grad Proj Datasets\Datasets (Normal)\Brain Tumors 2 Class (Benign&Malignant)\\Training\\Benign'
...
image_path='\\Users\\adham\\OneDrive\\Desktop\\Grad Proj Datasets\Datasets (Normal)\Brain Tumors 2 Class (Benign&Malignant)\\Training\\'
...
train_data_path=Path(r"\\Users\\adham\\OneDrive\\Desktop\\Grad Proj Datasets\Datasets (Normal)\Brain Tumors 2 Class (Benign&Malignant)\\Training\\")
...
model_history = model.fit(train_data_generator, epochs=5, validation_data=valid_data_generator, callbacks = [early_stopping])
