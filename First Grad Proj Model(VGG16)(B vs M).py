...
load_and_preprocess_images(Malignant)
load_and_preprocess_images(Benign)
...
model_history = model.fit(train_data_generator, epochs=5, validation_data=valid_data_generator)

# Evaluation
test_loss, test_accuracy = model.evaluate(test_data_generator)
print(f"Test Accuracy: {test_accuracy}")

# Predictions and visualization of only 25 images and their predictions with ground truths
