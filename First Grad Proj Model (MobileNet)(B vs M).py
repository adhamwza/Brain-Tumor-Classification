...
#MobileNetV2 imagenet Pre-trained Weights
...
def view_and_preprocess_images(directory, num_samples=25):
...
# Directory paths
    #"C:\Users\adham\OneDrive\Desktop\Grad Proj Datasets\Datasets (Normal)\Brain Tumors 2 Class (Benign&Malignant)\Training\Malignant"
    #"C:\Users\adham\OneDrive\Desktop\Grad Proj Datasets\Datasets (Normal)\Brain Tumors 2 Class (Benign&Malignant)\Training\Benign"
Malignant = r'\Users\adham\OneDrive\Desktop\Grad Proj Datasets\Datasets (Normal)\Brain Tumors 2 Class (Benign&Malignant)\Training\Malignant'
Benign = r'\Users\adham\OneDrive\Desktop\Grad Proj Datasets\Datasets (Normal)\Brain Tumors 2 Class (Benign&Malignant)\Training\Benign'


# Load and preprocess images for each class
view_and_preprocess_images(Malignant)
view_and_preprocess_images(Benign)

# Data paths
image_path = r'\\Users\\adham\\OneDrive\\Desktop\\Grad Proj Datasets\Datasets (Normal)\Brain Tumors 2 Class (Benign&Malignant)\\Training\\'
train_data_path = Path(image_path)
valid_data_path = Path(r'\\Users\\adham\\OneDrive\\Desktop\\Grad Proj Datasets\Datasets (Normal)\Brain Tumors 2 Class (Benign&Malignant)\\Validation\\')
test_data_path = Path(r'\\Users\\adham\\OneDrive\\Desktop\\Grad Proj Datasets\Datasets (Normal)\Brain Tumors 2 Class (Benign&Malignant)\\Testing\\')
...
#Train Data Augmented image generator
...
# Training
#And training times (epochs)
model_history = model.fit(train_data_generator, epochs=50, validation_data=valid_data_generator)

model.save("MobileNet_BenignVSMalignant_Model.h5")

# Evaluation
test_loss, test_accuracy = model.evaluate(test_data_generator)
print(f"Test Accuracy: {test_accuracy}")

# Predictions and visualization of only 25 images with their predictions and ground truth labels
