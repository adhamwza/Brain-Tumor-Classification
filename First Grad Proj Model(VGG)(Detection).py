...
# Directory paths
    ...
    #r'\Users\adham\OneDrive\Desktop\Grad Proj Datasets\Datasets (Normal)\Brain Tumor 2 Classes(1)\Brain Tumor\no\Training'
...
view_and_preprocess_data(Yes_Tumor)
...
#Sving the model
model.save("VGG_Detection_Model.h5")

#To load the model:
#tf.keras.models.load_model("path_to_save_model.h5")
...
# Predictions and visualization of only 25 images with preductions and ground truth values
...
#Notes:
#v long time to train, 50 epochs over 9 hours runtime
#96% acc, 0.2 loss testing
#97% acc, 0.06 loss training
#98% acc, 0.09 loss validation
#used data aug